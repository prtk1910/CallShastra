            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>User List <small>Customer Care Agents</small></h2>

                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <p class="text-muted font-13 m-b-30">
                                    Here lie all your user records. You can copy and print these records using the buttons provided, or even download the list in CSV file format.
                                </p>
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    while($row = $result->fetch_assoc()){
                                        ...
                                        $office = $row['location'];
                                        $age = $row['age'];
                                        echo "<tr><td style='width: 200px;'><a href='userprofile.php?id=".$id."'>".$id."</a></td><td style='width: 600px;'>".$firstname."</td><td>".$position."</td><td>".$office."</td><td>".$age."</td></tr>";
                                    }
                                    ?>
