        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index2.php" class="site_title"><i class="fa fa-paw"></i> <span>Callshastra</span></a>
            </div>
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["customerend"]["tmp_name"], $target_file)) {
        echo "The file ". basename( $_FILES["customerend"]["name"]). " has been uploaded.<br>";
    } else {
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["execend"]["tmp_name"], $target_file)) {
        echo "The file ". basename( $_FILES["execend"]["name"]). " has been uploaded.<br>";
    } else {
        echo "Sorry, there was an error uploading your file.";
    }
}
