        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title" style="font-family: Pacifico;"><i class="fa fa-paw"></i> <span>Callshastra</span></a>
            </div>
...
$sql="SELECT id FROM executors ORDER BY ID DESC LIMIT 1";
...
$sql="insert into executors(name,position,office,age,startdate,salary,email) values('$name','$position','$office',$age,'$startdate',$salary,'$email')";


if($conn->query($sql))
{
  echo "Employee Addition Successful";
}
else
